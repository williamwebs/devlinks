          ...
          <div className="container h-full flex items-center pt-20">
            <div className="w-full md:w-1/2">
              ...
              <p className="my-4 text-bgGrey font-medium text-base">
                ...
                achievements with the world. Join 50M+ developers, engineers,
                and designers who use DevLinks to streamline their online
                presence.
              </p>
              <Button
                variant="default"
        ...
        <section className="h-screen w-full bg-stackoverflow py-32">
          <div className="container h-full flex items-center">
            <div className="w-full md:w-1/2 ml-auto">
              ...
              <p className="my-4 text-bgGrey font-medium text-base">
                Connect your social media profiles, projects, and achievements
                to create a personalized portfolio. Share your unique DevLinks
                URL on Instagram, TikTok, Twitter, and other platforms to drive
          ...
          <div className="container h-full flex items-center">
            <div className="w-full md:w-1/2">
              ...
              <p className="my-4 text-bgGrey font-medium text-base">
                ...
                with the world. Add your unique DevLinks URL to your social
                media bios, email signature, and offline materials to drive
